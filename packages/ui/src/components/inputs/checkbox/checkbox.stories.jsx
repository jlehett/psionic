            ...
            page: () => (
                <>
                    <div className="storybookWrapper">
                        ...
                        <Subtitle/>
                        <p>
                            The <Code>Checkbox</Code> components provides a general purpose checkbox
                        ...
                        <p>
                            The following information is stored in an object under the input's
                            <Code>fieldKey</Code> in the form's <Code>onSubmit</Code> callback param:
                            <table>
                                <tr>
                                    <th>Key</th>
                                    <th>Type</th>
