...
Basic.args = {
    children: (
        <button style={{ width: '200px', height: '100px', cursor: 'pointer', background: 'white', outline: 'none', border: '1px solid black' }}>
            Submit
        </button>
    ),
...
ComplexContent.args = {
    ...
    content: (
        <div>
            ...
            <p><b>Is this realistic?</b> Well, probably not, but we tested anyway.</p>
            <p>Here's an image:</p>
            <img
